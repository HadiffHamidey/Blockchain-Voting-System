...
contract Election {
    ...
    function voteStatus(address acc) public view returns (bool){
        return voterDetails[acc].hasVoted;
    }

    function getCandidateCount(uint256 candidateId) public view returns (uint256){
        require(end == true);
        return candidateDetails[candidateId].voteCount;
    }
